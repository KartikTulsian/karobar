// src/components/dashboard/manager/ManagerStatsGrid.tsx
import { IndianRupee, Receipt, TriangleAlert, Users } from 'lucide-react';
...
export default function ManagerStatsGrid() {
  return (
    // Uses lg:grid-cols-4 to evenly space the 4 operational metrics
    <div className='grid gap-4 lg:grid-cols-4 grid-cols-2'>
        {MOCK_MANAGER_STATS.map((stat, index) => (
            <div 
                key={index}
